...
import com.quimodotcom.blackboxcure.Model.BookmarksDBHelper;
import com.quimodotcom.blackboxcure.Model.MapsModel;
...
import com.quimodotcom.blackboxcure.UI.PrettyToast;
...
public class MapsPresenter implements MapsImpl.PresenterImpl {
    ...
    public static final String UPDATE_UI_ACTION = "com.quimodotcom.blackboxcure.actionservice.daemons.update_speedbar_ui";
    ...
    private void openGpForRate() {
        ...
        intent.setData(Uri.parse("market://details?id=com.quimodotcom.blackboxcure"));
        try {
