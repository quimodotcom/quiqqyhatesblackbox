...
public class AppPreferences {
    ...
    public static int getUpdatesDelay(@NonNull Context context){
        return (int) (Float.parseFloat(PreferenceManager.getDefaultSharedPreferences(context).getString(BlackBoxCureApp.GPS_UPDATES_DELAY, String.valueOf(1))) * 1000);
    }
    public static boolean getBrakeAtTurning(@NonNull Context context){
        return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(BlackBoxCureApp.BRAKE_AT_TURNING, true);
    }
    public static int getStandartUnit(@NonNull Context context){
        return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context).getString(BlackBoxCureApp.STANDART_UNIT, String.valueOf(KILOMETERS)));
    }
    ...
    public static int getAccuracy(Context context){
        return (int) Float.parseFloat(PreferenceManager.getDefaultSharedPreferences(context).getString(BlackBoxCureApp.ACCURACY_SETTINGS, "10"));
    }
